    ...
    steps: [
      {
        ...
        body: "Точки и линии — это сущности и связи, извлечённые Understand-Anything из этого проекта (код / wiki). Каждый узел — это файл, концепция, сущность или утверждение.",
